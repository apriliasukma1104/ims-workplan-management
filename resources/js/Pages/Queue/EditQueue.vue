          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group mt-3 ml-3">
                ...
                <input type="text" name="id" class="form-control form-control-sm" v-model="formData.id" hidden>
                <input type="text" name="name" class="form-control form-control-sm" v-model="formData.name">
              </div>
              <div class="form-group mt-3 ml-3">
                <label for="description" class="control-label">Description</label>
                <textarea name="description" class="form-control" style="height: 118px; font-size: 14px;" v-model="formData.description"></textarea>
              </div>
              <div class="form-group mt-3 ml-3">
            ...
            <div class="col-md-6">
              ...
              <div class="form-group mt-3 mr-3">
                <label for="team_members" class="control-label" style="display: block; margin-top: 1rem;">Team Member/s 2</label>
              ...
              <div class="form-group mt-3 mr-3">
                ...
                <input type="number" name="year" id="year" class="form-control form-control-sm" v-model="formData.year">
              </div>
              <div class="form-group mt-3 mr-3">
