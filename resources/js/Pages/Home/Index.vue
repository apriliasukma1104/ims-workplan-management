...
<layout>
	<div>
        <div style="background-color:white;height: 200px;width: 100%;display: flex;justify-content: center;align-items: center;flex-direction: column;margin-top: 10rem">
            ...
            <span class="brand-text font-weight-light text" style="font-size: 40px;"><b style="color: #ea6601;">Project Monitoring</b> IMS</span>
            <small><b>Made by Aprilia SD | PKL IMS 2023</b> </small>
        </div>
    </div>
</layout>
